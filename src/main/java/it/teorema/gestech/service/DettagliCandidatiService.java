...
public interface DettagliCandidatiService extends JpaRepository <DettagliCandidati, Integer> {
	...
	@Query("select dc.idEsitoColloquio as idEsitoColloquio, ec.nome as esitoColloquio, "
			+ "dc.dataInserimento as dataInserimento, dc.competenzaPrincipale as competenzaPrincipale, "
			+ "dc.dataColloquio as dataColloquio, dc.annoColloquio as annoColloquio, dc.fonteReperimento as fonteReperimento, "
